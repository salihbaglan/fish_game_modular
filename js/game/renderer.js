...
export default class Renderer {
    constructor(canvas) {
        ...
        this.backgroundImage.src = 'assets/images/Bg.webp';
        ...
        this.jellyfishImage.src = 'assets/images/ocemom.webp';
        ...
        this.bombImage.src = 'assets/images/Bomb.webp';
        ...
        this.bubbleImage.src = 'assets/images/Buble.webp';
        ...
        this.hookImage.src = 'assets/images/kanca.webp';
        ...
        this.magnetImage.src = 'assets/images/magnet.webp';
        ...
        for (let i = 1; i <= 6; i++) {
            const img = new Image();
            img.src = `assets/images/garbage/${i}.webp`;
            img.onload = () => {
                this.garbageLoaded++;
        ...
        // Kalkan görseli yükle (Buble.webp kullan)
        this.shieldImage = new Image();
        this.shieldImage.src = 'assets/images/Buble.webp';
    ...
    drawShield(shield, cameraZoom = 1) {
        ...
        if (this.shieldLoaded && this.shieldImage.complete) {
            // Kalkan görselini çiz (Buble.webp)
    ...
    drawParticle(particle, cameraZoom) {
        ...
        if (particle.type === 'bubble') {
            // Baloncuk çizimi (Buble.webp ile)
